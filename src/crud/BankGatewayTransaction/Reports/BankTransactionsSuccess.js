...
export default $component => ({
  name: 'ecommerce.bank_transactions.windowed',
  icon: 'mdi-bank-transfer',
  type: 'bar',
  url: '/api/bank-gateway-transactions/reports',
  unit: $component.$t('components.admin.crud.bankGatewayTransaction.reports.success.unit'),
  title: $component.$t('components.admin.crud.bankGatewayTransaction.reports.success.title'),
  bindings: [
