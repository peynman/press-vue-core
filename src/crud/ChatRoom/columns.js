...
export default function ($component) {
  return [
    ...
    decimalColumn('participants_count', $component.$t('components.admin.crud.columns.participantsCount'), 'item.participants_count'),
    decimalColumn('messages', $component.$t('components.admin.crud.columns.messagesCount'), 'item.messages_count'),
    decimalColumn('unseen_messages', $component.$t('components.admin.crud.columns.unseenMessagesCount'), 'item.unseen_messages_count'),
