...
export default function ($component) {
  return [{
    ...
    objectStatusColumn($component, 'gateway', $component.$t('components.admin.crud.columns.gateway'), 'item.gateway', Gateways($component)),
    userProfileColumn($component, 'author', $component.$t('components.admin.crud.columns.user'), 'item.author'),
