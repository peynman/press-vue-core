...
export default $component => ({
  name: 'auth.signin.windowed',
  icon: 'mdi-account-key',
  type: 'bar',
  url: '/api/users/reports',
  unit: $component.$t('components.admin.crud.user.reports.signin.unit'),
  title: $component.$t('components.admin.crud.user.reports.signin.title'),
  bindings: [
